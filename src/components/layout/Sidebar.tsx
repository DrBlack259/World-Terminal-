...
export default function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <aside
      className={clsx(
        "flex-shrink-0 terminal-surface rounded-none border-l-0 border-y-0 border-r border-terminal-border flex flex-col z-40 transition-transform duration-200",
